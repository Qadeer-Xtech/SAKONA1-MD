...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Qadeer-Xtech/SAKONA1-MD';
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ǫᴀᴅᴇᴇʀ ᴋʜᴀɴ*`;
        ...
        const style8 = `✦ 𝐒𝐀𝐊𝐎𝐍𝐀𝟏-𝐌𝐃 Repository ✦
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴀᴋᴏɴᴀ ᴍᴅ*`;
        ...
        const thumbnailBuffer = await axios.get('https://qu.ax/hDLFX.png', { responseType: 'arraybuffer' }).then(res => res.data);
