...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get('https://api.github.com/repos/Qadeer-Xtech/SAKONA1-MD/commits/main');
        ...
        await reply('SAKONA1-MD UPDATING WAIT PLEASE...');

        // 4. Download the latest version of the repository as a zip file
        const zipPath = path.join(__dirname, 'latest.zip');
        const { data: zipBuffer } = await axios.get('https://github.com/Qadeer-Xtech/SAKONA1-MD/archive/main.zip', {
        ...
        const sourcePath = path.join(extractPath, 'SAKONA1-MD-main');
