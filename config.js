...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY SAKONA-MD 🤍*",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://qu.ax/hDLFX.png",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝐒𝐀𝐊𝐎𝐍𝐀-𝐌𝐃",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴀᴋᴏɴᴀ ᴍᴅ*",
// bot description    
ALIVE_IMG: process.env.ALIVE_IMG || "https://qu.ax/hDLFX.png",
// image for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> *SAKONA1-MD*⚡",
// alive msg content
